...
%dmax = 0.003; % maximum distance between partners
...
for s=1:3
    ...
    Rii_2{(s)} = g.w1*QVP{s2(s)}+g.w2*Q + g.r*Qd;
    Ri_i_2{(s)} = -g.w2*Q;
    R_i_i_2{(s)} = g.w2*Q;
    ri_2{(s)} = -g.w1*(g.VP2(1)'*g.giVP{s2(s)}*g.Sx...
    ...
    z_2{(s)} = 1/2*(g.w1*(g.u0'*QVP00{s2(s)}*g.u0 ...
                         +g.VP2(1).^2 ...
                         +g.VP2(2).^2 ...
